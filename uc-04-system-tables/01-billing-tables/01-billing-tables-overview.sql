...
-- MAGIC
-- MAGIC As part of this demo, we also installed this dashboard. You can access it here: <a dbdemos-dashboard-id="account-usage" href='/sql/dashboardsv3/01efa74c2fa21e84ac971d8fb637167c' target="_blank">Account Usage Cost tracking dashboard</a>
...
-- MAGIC
-- MAGIC You can access it here: <a dbdemos-dashboard-id="model-serving-cost" href='/sql/dashboardsv3/01efa74c320f1269a0f655535185925e' target="_blank">Model Serving Endpoint Cost tracking dashboard</a>
...
-- MAGIC
-- MAGIC You can access it here: <a dbdemos-dashboard-id="warehouse-serverless-cost" href='/sql/dashboardsv3/01efa74c33241354a1249f5494c75e8c' target="_blank">SQL Warehouse Endpoint Cost tracking dashboard</a>
...
-- MAGIC
-- MAGIC Want to Track your job runs and find which job is consuming the most resources? Analyze your Workflow and Job consumption with the <a dbdemos-dashboard-id="worklow-analysis" href='/sql/dashboardsv3/01efa74c344e1bf2b69c69495f01ac57' target="_blank">Workflow and Job Cost tracking dashboard example</a>

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC *Looking for the notebook used to create the <a dbdemos-dashboard-id="cost-forecasting" href='/sql/dashboardsv3/01efa74c30fd1d848baaf917f33d96ce' target="_blank">forecasting dashboard</a>? Jump to the [02-forecast-billing-tables]($./02-forecast-billing-tables) notebook.*
