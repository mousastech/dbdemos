...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=AI-BI&org_id=1444828305810485&notebook=%2FAI-BI-Sales-pipeline&demo_name=aibi-sales-pipeline-review&event=VIEW&path=%2F_dbdemos%2FAI-BI%2Faibi-sales-pipeline-review%2FAI-BI-Sales-pipeline&version=1">
...
# MAGIC
# MAGIC
# MAGIC Open the <a dbdemos-dashboard-id="sales-pipeline" href='/sql/dashboardsv3/01efa74dea881ffbbd34482432c68a88' target="_blank">Sales Pipeline Dashboard to analyze & track main KPIs</a>
...
# MAGIC
# MAGIC Open the <a dbdemos-genie-id="sales-pipeline" href='/genie/rooms/01efa74dfd6f1477b684cac1429137bf' target="_blank">Sales Pipeline Genie space to deep dive into your data</a>
